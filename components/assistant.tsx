    ...
    <div className="flex flex-col bg-gray-100">
      {showChat ? (
        <div className="flex justify-end">
          <button
            className="fixed bottom-8 right-8 w-16 h-16 rounded-full bg-blue-500 text-white flex items-center justify-center"
            onClick={toggleChat}
          >
      ...
      {showChat && (
        <div className="fixed bottom-16 right-8 w-80 bg-white rounded-lg shadow-md mb-10">
