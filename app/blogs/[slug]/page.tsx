...
import { likeincrement } from '@/lib/getlikes';
  ...
  return (
    <div className="bg-black text-white p-8 md:p-12 lg:p-16 ">
      {isLoading ? (
        ...
        <div className='pt-14 h-screen pl-0 pr-0 xl:pl-32 xl:pr-32'>
          <h1 className="text-4xl font-bold mb-4 font-mono">{blog.title}</h1>
          <div className="flex items-center mb-4">
            <p className="mr-4 font-mono text-xl"><span className='font-semibold'>Author: </span><span className='text-gray-200'>{blog.author}</span></p>
            <p className='font-mono text-xl'><span className='font-semibold'>Created Date: </span><span className='text-gray-200'>{formatDate(blog.createdAt)}</span></p>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <span className="text-3xl cursor-pointer" onClick={handleDislike}>
                👎
              </span>
